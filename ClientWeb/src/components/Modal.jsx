...
// 新增：
//   closeOnOverlayClick 是否允许点击蒙层关闭（默认 true；编辑类弹窗建议 false 防误操作）
//   closeOnEsc         是否允许 ESC 关闭（默认 true）
export default function Modal({ title, onClose, children, footer, width = 720, closeOnOverlayClick = true, closeOnEsc = true }) {
  ...
  return createPortal((
    <div className="modal-mask" onClick={(e) => { if (closeOnOverlayClick && e.target === e.currentTarget) onClose && onClose() }}>
