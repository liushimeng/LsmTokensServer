...
// TestChatStatsWS_NormalizeDays 守护：days 白名单 [0,1,3,5,7,14,30,60,90] 严格匹配；
// 白名单外（含负值、>90、非整）回落 7
func TestChatStatsWS_NormalizeDays(t *testing.T) {
	cases := []struct {
		...
		{0, 0}, {1, 1}, {3, 3}, {5, 5}, {7, 7}, {14, 14}, {30, 30}, {60, 60}, {90, 90},
		{-1, 7}, {-12, 7}, {2, 7}, {4, 7}, {15, 7}, {99, 7}, {100, 7}, {365, 7}, {1000, 7},
	}
	for _, c := range cases {
